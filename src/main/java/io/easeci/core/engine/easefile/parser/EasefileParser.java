...
public interface EasefileParser {
     ...
     * @param easefileSource is a source path of Easefile that was loaded as String content
     ...
     * */
    EasefileParseResult parse(String easefileContent, Path easefileSource);
}
