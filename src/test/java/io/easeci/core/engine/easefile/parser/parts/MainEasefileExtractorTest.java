...
import static io.easeci.core.engine.easefile.parser.Utils.readValidTestEasefile;
...
class MainEasefileExtractorTest extends BaseWorkspaceContextTest {
    ...
    void fetchCrudeSuccessTest() throws PipelinePartCriticalError {
        ...
        assertAll(() -> assertEquals(1, keyPart.size()),
                () -> assertEquals(1, executorPart.size()),
                () -> assertEquals(13, variablesPart.size()),
                () -> assertEquals(12, stagesPart.size()));
    }
